...
const accessKey = 'dAOpc1T8ihf_VRb2iimYotUQI9VPY0Gkcj_1S9gI';
const secretKey = 'z5WxFhMk23E1gXlExhkG66AxjGyAmF_PUbYzjP6W';
...
this.fetchUploadToken = function(scopeName) {
  var mac = getMac();
  var options = {
      scope: scopeName,
  };
